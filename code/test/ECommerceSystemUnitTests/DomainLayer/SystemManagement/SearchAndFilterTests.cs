...
namespace ECommerceSystem.DomainLayer.SystemManagement.Tests
{
    ...
    public class SearchAndFilterTests
    {
        ...
        public void setUpFixture()
        {
            ...
            {
                { ProductInventory.Create("Dell XPS 15inch", "Laptop", null, null, 1600.0, 30, Category.ELECTRONICS, new List<string>() { "Laptop", "Computer", "PC"}, _prodIDCounter++, _prodInvID++)},
                { ProductInventory.Create("Sony DSLR Camera", "Best camera", null, null, 500.0, 20, Category.CAMERASPHOTOS, new List<string>() { "Camera", "DSLR", "Sony"}, _prodIDCounter++, _prodInvID++)},
                { ProductInventory.Create("Google Pixel 4", "New google phone", null, null, 700.0, 10, Category.CELLPHONES, new List<string>() { "Google", "Pixel", "Phone"}, _prodIDCounter++, _prodInvID++)},
                { ProductInventory.Create("Google Pixel 4", "New google phone", null, null, 700.0, 10, Category.ELECTRONICS, new List<string>() { "Google", "Pixel", "Phone"}, _prodIDCounter++, _prodInvID++)},
                { ProductInventory.Create("Western Digital 4TB HardDrive", "4TB Harddrive", null, null, 100.0, 100, Category.ELECTRONICS, new List<string>() { "WD", "Harddrive"}, _prodIDCounter++, _prodInvID++)},
                { ProductInventory.Create("Dyson V11", "Vaccum cleaner", null, null, 300.0, 5, Category.HOMEGARDEN, new List<string>() { "Dyson", "Vaccum"}, _prodIDCounter++, _prodInvID++)},
                { ProductInventory.Create("Logitech MX Master 3", "Computer mice", null, null, 110.0, 300, Category.ELECTRONICS, new List<string>() { "Logitech", "Mice"}, _prodIDCounter++, _prodInvID++)},
                { ProductInventory.Create("Linkin Park - Meteora", "Nu-Metal music album", null, null, 20.0, 2, Category.MUSIC, new List<string>() { "Music", "LP", "Nu-Metal"}, _prodIDCounter++, _prodInvID++)},
                { ProductInventory.Create("Windows 10 Home", "Microsoft Operatin system", null, null, 25.0, 5000, Category.SOFTWARE, new List<string>() { "OS", "Microsoft", "Windows"}, _prodIDCounter++, _prodInvID++)},
                { ProductInventory.Create("iPhone 11 XL", "Apple new smartphone", null, null, 800.0, 30, Category.CELLPHONES, new List<string>() { "Apple", "Smartphone", "Phone"}, _prodIDCounter++, _prodInvID++)},
            };
