...
namespace ECommerceSystem.DomainLayer.UserManagement.Tests
{
    ...
    public class UsersManagementTests
    {
        ...
        public void getUserCartTest()
        {
            ...
            storeCart.AddToCart(new StoresManagement.Product(null, null, 2, 2.0, Guid.NewGuid(), "", ""), 1);
        ...
        {
            var product = new Product(null, null, 10, 25.5, Guid.NewGuid(), "", "");
            var product2 = new Product(null, null, 10, 15.5, Guid.NewGuid(), "", "");
