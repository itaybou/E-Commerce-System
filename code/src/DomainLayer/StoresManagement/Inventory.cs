...
namespace ECommerceSystem.DomainLayer.StoresManagement
{
    public class Inventory : IEnumerable<ProductInventory>
    {
        ...
        public Guid addProductInv(string productName, string description, Discount discount, PurchaseType purchaseType, double price, int quantity, Category category, List<string> keywords, Guid productInvID)
        {
            ...
            ProductInventory productInventory = ProductInventory.Create(productName, description, discount, purchaseType, price, quantity, category, keywords, guid, productInvID);
        ...
        public Guid addProduct(string productInvName, Discount discount, PurchaseType purchaseType, int quantity)
        {
            ...
            {
                Guid guid = Guid.NewGuid();
                if (productInventory.addProduct(discount, purchaseType, quantity, productInventory.Price, guid)){
                    return guid;
                }
                else
                {
